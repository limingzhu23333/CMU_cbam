...
class CMU_CBAM(nn.Module): 
    def __init__(self, in_chans=1,num_classes=4):
        super(CMU_CBAM, self).__init__()

        self.Maxpool = nn.MaxPool2d(kernel_size=2, stride=2)

        self.Conv1 = conv_block(ch_in=in_chans, ch_out=16)  # 64
        self.Conv2 = CMUNeXtBlock(ch_in=16, ch_out=32)  # 64 128
        self.Conv3 = CMUNeXtBlock(ch_in=32, ch_out=64)  # 128 256
        self.Conv4 = CMUNeXtBlock(ch_in=64, ch_out=128)  # 256 512
        self.Conv5 = CMUNeXtBlock(ch_in=128, ch_out=256)  # 512 1024
...
if __name__ =="__main__":
    ...
    m = CMU_CBAM(in_chans=1,num_classes=4)
